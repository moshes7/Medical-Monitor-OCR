...
if __name__ == '__main__':
    ...
    image_name = 'images/barcode_monitor.jpg'
    # image_name = 'images/11.jpg'
    # image_name = 'images/1.tiff'
    # image_name = 'images/2.tiff'
    # image_name = 'images/3.tiff'

    gray_flag = True

    image = io.imread(image_name, as_gray=gray_flag)

    print("Rectifying {}".format(image_name))
    save_name = '.'.join(image_name.split('.')[:-1]) + '_gray' * gray_flag + '_warped.jpg'

    image_rectified = rectify_image(image, clip_factor=4, algorithm='independent')

    io.imsave(save_name, image_rectified)
